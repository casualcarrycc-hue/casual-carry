  ...
  return (
    <div className="page-shell pt-space-md md:pt-space-xl pb-space-2xl">
      <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-space-lg lg:gap-space-2xl lg:items-start">
        ...
        <div className="lg:sticky lg:top-28 lg:py-space-lg">
          <span className="font-label-sm text-label-sm uppercase tracking-widest text-primary mb-0.5 block">
            {product.silhouette}
          </span>
          ...
          <div className="p-space-md bg-surface-container-low rounded-xl mb-space-lg">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mt-space-xs">
              Online purchasing is not open yet. Contact the atelier for
